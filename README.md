...
- [RustPBX](https://rustpbx.com) - Software Defined SIP proxy, location/registrar/b2bua for a voice agent server. ([Source Code](https://github.com/restsend/rustpbx)) `MIT` `RUST`
